...
const TournamentBracket = ({ predictions, onChange, isLocked }) => {
  ...
  return (
    <Box className="tournament-bracket">
      {/* Column 1 - Round of 32 (Sedicesimi) */}
      <Box className="bracket-column round-32">
        <Typography variant="h6" className="round-title">SEDICESIMI</Typography>
      ...
      {/* Column 2 - Round of 16 (Ottavi) */}
      <Box className="bracket-column round-16">
        <Typography variant="h6" className="round-title">OTTAVI</Typography>
      ...
      {/* Column 3 - Quarter Finals (Quarti) */}
      <Box className="bracket-column quarters">
        <Typography variant="h6" className="round-title">QUARTI</Typography>
      ...
      {/* Column 4 - Semi Finals (Semifinali) */}
      <Box className="bracket-column semis">
      ...
      {/* Column 5 - Final (Finale) */}
      <Box className="bracket-column final">
        ...
        <Paper className="final-box" elevation={3}>
          ...
          <Autocomplete
            ...
            disabled={isLocked}
            renderInput={(params) => (
              <TextField {...params} placeholder="Finalista 1" className="team-input final-input" />
            )}
            freeSolo
          />
          <Autocomplete
            ...
            disabled={isLocked}
            renderInput={(params) => (
              <TextField {...params} placeholder="Finalista 2" className="team-input final-input" />
            )}
            freeSolo
          />
        </Paper>
